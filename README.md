...
O arquivo `job_skill_graph.gexf` representa a rede completa e os notebooks no repositório abrangem a coleta de dados, processamento dos dados originais, construção do grafo e análises.
